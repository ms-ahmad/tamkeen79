...
class AbstractBaseRating(models.Model):
    ...
    """
    count = models.PositiveIntegerField(("عدد المصوتين"),default=0)
    total = models.PositiveIntegerField(("المجموع"),default=0)
    average = models.DecimalField(("متوسط التقييم"),max_digits=6, decimal_places=3, default=Decimal(0.0))
